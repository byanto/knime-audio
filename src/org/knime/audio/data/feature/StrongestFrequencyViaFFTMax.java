...
public class StrongestFrequencyViaFFTMax extends FeatureExtractor {
	...
	protected StrongestFrequencyViaFFTMax() {
		super(FeatureType.STRONGEST_FREQUENCY_VIA_FFT_MAXIMUM);
	}
	...
	public double[] extractFeature(final AudioSamples samples, final double[][] additionalFeatureValues)
			throws Exception {
		return new jAudioFeatureExtractor.AudioFeatures.StrongestFrequencyViaFFTMax()
