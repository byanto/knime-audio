 ...
 */
public class BeatHistogramBinLabels extends FeatureExtractor {

	static final int NUMBER_BINS = 256;

	protected BeatHistogramBinLabels() {
		super(FeatureType.BEAT_HISTOGRAM_BIN_LABELS);
	}
	...
	public double[] extractFeature(final AudioSamples samples, final double[][] additionalFeatureValues)
			throws Exception {
		return new BeatHistogramLabels().extractFeature(samples.getSamplesMixedDownIntoOneChannel(),
