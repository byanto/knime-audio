...
public class StrongestFrequencyViaSpectralCentroid extends FeatureExtractor {
	...
	protected StrongestFrequencyViaSpectralCentroid() {
		super(FeatureType.STRONGEST_FREQUENCY_VIA_SPECTRAL_CENTROID);
	}
	...
	public double[] extractFeature(final AudioSamples samples, final double[][] additionalFeatureValues)
			throws Exception {
		return new jAudioFeatureExtractor.AudioFeatures.StrongestFrequencyViaSpectralCentroid().extractFeature(
