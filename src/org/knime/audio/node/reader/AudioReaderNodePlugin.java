 ...
 */
public class AudioReaderNodePlugin extends Plugin {
    // The shared instance.
    private static AudioReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public AudioReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static AudioReaderNodePlugin getDefault() {
        return plugin;
    }
